    ...
    <nav class="glass-nav shadow-lg sticky top-0 z-50 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center gap-1">
                    ...
                    <a href="{{ route('public.gallery') }}" class="px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 {{ request()->routeIs('public.gallery') ? 'text-[#112c71] bg-blue-50' : 'text-gray-600 hover:text-[#112c71] hover:bg-gray-50' }}">{{ __('messages.nav.gallery') }}</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100 shadow-lg">
            <div class="px-4 py-4 space-y-1">
                ...
                <a href="{{ route('public.gallery') }}" class="block py-3 px-4 text-gray-700 hover:text-[#112c71] font-semibold rounded-lg hover:bg-gray-50 transition">{{ __('messages.nav.gallery') }}</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="{{ route('public.gallery') }}" class="text-gray-400 hover:text-white transition-colors flex items-center gap-2"><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M{{ $isRtl ? '12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z' : '7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z' }}" clip-rule="evenodd"/></svg>{{ __('messages.nav.gallery') }}</a></li>
